...
<head>
    ...
    <title>Register - Toko Monel</title>
...
<body>
    <div class="register-container">
        <div class="register-box animate__animated animate__fadeInDown">
            <h2 class="animate__animated animate__fadeIn">Register Monel Store</h2>
            <?php if($error): ?>
            ...
            <form action="" method="post" id="registerForm">
                ...
                <div class="links">
                    <div class="login-link">
                        <p>Sudah punya akun? <a href="login.php" class="animate__animated animate__pulse">Login disini</a></p>
                    </div>
                </div>
            </form>
        </div>
